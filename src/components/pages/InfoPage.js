...
export default function InfoPage() {
  return (
    <div id="info-page">
      ...
      <h3 className="heading">A page to explain how to use this web app.</h3>

      <div className="basic-style card accent1-color">
        <h2 className="heading">Cooks Page</h2>
      ...
      <div className="basic-style card dark-color">
        <h2 className="heading">Calendar Page</h2>
      ...
      <div className="basic-style card primary-color">
        <h2 className="heading">Planner Page</h2>
